            ...
            <div class="right-side ">
                ...
                <div class="share noPrint">
                    <fieldset class="field-set" style="border-radius: 15px;">
                        ...
                        <a href="http://api.whatsapp.com/send?text=http://localhost/Recipe/web/user/view-recipe.php?Permalink=<?php echo $row['Permalink']?>"
                            target="_blank">
                            <img class="share-img" src="../icons/whatsapp.png"></a>
                        <a href="http://www.facebook.com/sharer.php?u=http://localhost/Recipe/web/user/view-recipe.php?Permalink=<?php echo $row['Permalink']?>"
                            target="_blank">
                            <img class="share-img" src="../icons/facebook.png"></a>
                        <a href="http://www.instagram.com/sharer.php?u=http://localhost/Recipe/web/user/view-recipe.php?Permalink=<?php echo $row['Permalink']?>"
                            target="_blank">
