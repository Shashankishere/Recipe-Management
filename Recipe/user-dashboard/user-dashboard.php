...
$Gender = "";
$Location = "";
$Profile_image = "default.jpg"; // fallback image
    ...
    <main>
        <div class="personalDetails">
            ...
            <form name="updateUserDetails" onsubmit="return validateUserDetails()" action="update-user-details.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="Bio" value="<?php echo htmlspecialchars($Bio); ?>"><br><br>

                <label for="Gender"> Gender </label>
                <span class="Gender_radio">
                    <input type="radio" name="Gender" class="radio" value="Male" <?php if ($Gender == "Male") echo "checked"; ?>> Male 
                    <input type="radio" name="Gender" class="radio" value="Female" <?php if ($Gender == "Female") echo "checked"; ?>> Female
                </span><br><br>
            ...
            <div class="accountDetails">
                ...
                <form name="updateAccountDetails" onsubmit="return validateAccountDetails()" action="update-account-details.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="User_email" value="<?php echo htmlspecialchars($User_email); ?>" required><br><br>

                    <label for="User_Password"> Password </label><br>
                    <input type="password" name="User_Password" value="<?php echo htmlspecialchars($User_Password); ?>" required><br><br>
