...
if (!isset($_SESSION['userid'])) {
    header("Location: http://localhost/Recipe/login.php"); // Redirect to login if not logged in
    die();
}
...
$First_name = $Last_name = $Gender = $Location = $Bio = $Profile_image = "Not available";
...
if ($result && $result->num_rows > 0) {
    ...
    $Profile_image = $row['Profile_image'] ?: "default.jpg"; // fallback to default image if not set
} else {
    echo "<p style='padding:10px;'>No profile information found.</p>";
}
?>
...
<body>
    ...
    <div class="grid">
        ...
        <div id="profile_image">
            <img src="../images/profile/<?php echo htmlspecialchars($Profile_image); ?>" alt="Profile image" height="300px">
        </div>
        ...
        <div class="userRecipe">
            ...
            <div class="recipe-container">
                                ...
                                <div>
                                    <p class="box-text">
                                        <a href="view-recipe.php?Permalink=<?php echo $row['Permalink']; ?>">
                                            <img class="recipe-img" src="../images/recipe/<?php echo htmlspecialchars($row['Recipe_image']); ?>" style="width: 380px; height: 300px">
                                        </a>
                                        <hr>

                                        <a class="r-name" href="view-recipe.php?Permalink=<?php echo $row['Permalink']; ?>">
                                            <h4 class="box-title"><?php echo htmlspecialchars($row['Title']); ?></h4>
                                        </a>
                                        ...
                                        <div id="time" title="Cook_time">
                                            ...
                                            <?php echo htmlspecialchars($row['Cook_time']); ?>
                                        </div>
                                        <br>
                                    </p>
                                </div>
                ...
                <?php
                    ...
                    echo "<h3>You have no Public recipes</h3>";
                }
                ?>
            </div>
        </div>
